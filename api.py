...
def chk(lista):
    ...
    try:
        ...
        data = {
            ...
            "query": "mutation TokenizeCreditCard($input: TokenizeCreditCardInput!) {   tokenizeCreditCard(input: $input) {     token     creditCard {       bin       brandCode       last4       binData {         prepaid         healthcaredebit         durbinRegulated         commercial         payroll         issuingBank         countryOfIssuance         productId       }     }   } }",
            "variables": {
                "input": {
                    "creditCard": {
                        "number": cc,
        ...
        if response_dict['data']['tokenizeCreditCard']['token']:
            ...
            url2 = 'https://api.braintreegateway.com/merchants/rh2g34xtgrzpnxbh/client_api/v1/payment_methods/{token}/three_d_secure/lookup'
